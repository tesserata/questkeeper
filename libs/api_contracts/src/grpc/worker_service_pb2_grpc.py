...
class WorkerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetSessionMessageId = channel.unary_unary(
                '/questkeeper.worker.WorkerService/SetSessionMessageId',
        ...
        self.SetEventMessageId = channel.unary_unary(
                '/questkeeper.worker.WorkerService/SetEventMessageId',
                request_serializer=worker__service__pb2.SetMessageIdRequest.SerializeToString,
...
def add_WorkerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'questkeeper.worker.WorkerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('questkeeper.worker.WorkerService', rpc_method_handlers)
