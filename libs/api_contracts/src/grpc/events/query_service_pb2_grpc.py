...
class EventsQueryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEvent = channel.unary_unary(
                '/questkeeper.events.query_service.EventsQueryService/GetEvent',
...
def add_EventsQueryServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'questkeeper.events.query_service.EventsQueryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('questkeeper.events.query_service.EventsQueryService', rpc_method_handlers)
