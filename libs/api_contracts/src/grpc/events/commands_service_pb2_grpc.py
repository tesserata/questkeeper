...
class EventsCommandServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateEvent = channel.unary_unary(
                '/questkeeper.events.commands_service.EventsCommandService/CreateEvent',
        ...
        self.EditBasics = channel.unary_unary(
                '/questkeeper.events.commands_service.EventsCommandService/EditBasics',
        ...
        self.EditSchedule = channel.unary_unary(
                '/questkeeper.events.commands_service.EventsCommandService/EditSchedule',
        ...
        self.EditOrganization = channel.unary_unary(
                '/questkeeper.events.commands_service.EventsCommandService/EditOrganization',
        ...
        self.PublishEvent = channel.unary_unary(
                '/questkeeper.events.commands_service.EventsCommandService/PublishEvent',
        ...
        self.CancelEvent = channel.unary_unary(
                '/questkeeper.events.commands_service.EventsCommandService/CancelEvent',
                request_serializer=events_dot_commands__service__pb2.CancelEventRequest.SerializeToString,
                response_deserializer=events_dot_models__pb2.Event.FromString,
                _registered_method=True)


class EventsCommandServiceServicer(object):
    """--- domain commands service (write) ---
    """
...
def add_EventsCommandServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'questkeeper.events.commands_service.EventsCommandService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('questkeeper.events.commands_service.EventsCommandService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class EventsCommandService(object):
    """--- domain commands service (write) ---
    """
