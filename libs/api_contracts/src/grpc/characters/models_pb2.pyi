...
class CharacterInfo(_message.Message):
    __slots__ = ("user_id", "game_system", "name", "subclass", "level", "race", "notes")
    ...
    race: str
    notes: str
    def __init__(self, user_id: _Optional[int] = ..., game_system: _Optional[str] = ..., name: _Optional[str] = ..., subclass: _Optional[str] = ..., level: _Optional[int] = ..., race: _Optional[str] = ..., notes: _Optional[str] = ..., **kwargs) -> None: ...
