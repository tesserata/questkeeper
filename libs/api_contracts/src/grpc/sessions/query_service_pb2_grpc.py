...
class SessionQueryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSession = channel.unary_unary(
                '/questkeeper.sessions.query_service.SessionQueryService/GetSession',
        ...
        self.GetSessionView = channel.unary_unary(
                '/questkeeper.sessions.query_service.SessionQueryService/GetSessionView',
                request_serializer=sessions_dot_query__service__pb2.GetSessionRequest.SerializeToString,
                response_deserializer=sessions_dot_models__pb2.SessionView.FromString,
                _registered_method=True)
        self.GetSessionSummary = channel.unary_unary(
                '/questkeeper.sessions.query_service.SessionQueryService/GetSessionSummary',
                request_serializer=sessions_dot_query__service__pb2.GetSessionRequest.SerializeToString,
                response_deserializer=sessions_dot_models__pb2.SessionSummary.FromString,
                _registered_method=True)
        self.ListSessions = channel.unary_unary(
                '/questkeeper.sessions.query_service.SessionQueryService/ListSessions',
...
class SessionQueryServiceServicer(object):
    """--- queries service (read models/projections)
    """
...
def add_SessionQueryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'questkeeper.sessions.query_service.SessionQueryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('questkeeper.sessions.query_service.SessionQueryService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class SessionQueryService(object):
    """--- queries service (read models/projections)
    """
